...
export default function Guides() {
  return (
    <>
      <Head>
        <title>Guides — AI Ops Agency</title>
        <meta name="description" content="Practical AI operations guides for small agency teams." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
      </Head>
      <Nav />
      <main className="max-w-3xl mx-auto px-6 py-16">
        <h1 className="text-3xl font-bold text-gray-900">Guides</h1>
        <p className="mt-4 text-gray-600">Practical AI operations guides — coming soon.</p>
      </main>
