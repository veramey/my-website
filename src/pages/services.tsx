...
const included = [
  { label: 'Workflow review', description: 'Map your current ops and find where time is lost.' },
  { label: 'Tool stack review', description: 'Assess what you use and what you should cut or add.' },
  { label: 'Bottleneck identification', description: 'Pinpoint the highest-leverage points to fix first.' },
  { label: 'Implementation recommendations', description: 'A prioritised action list you can start on immediately.' },
]
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="AI Ops Audit for small agencies. Workflow review, tool stack review, bottleneck identification, and implementation recommendations. Join the waitlist." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Services — AI Ops for Small Agencies" />
        <meta property="og:description" content="AI Ops Audit for small agencies. Join the waitlist." />
      ...
      <main>
        ...
        <section className="max-w-5xl mx-auto px-6 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-gray-900 leading-tight tracking-tight">
              AI Ops Audit for Small Agencies
            </h1>
            <p className="mt-5 text-lg text-gray-600 leading-relaxed">
              A focused review of your workflows, tools, and ops — with a clear implementation plan to help your team run leaner with AI.
            </p>
          </div>
        </section>
        ...
        <section className="border-t border-gray-100 bg-gray-50">
          <div className="max-w-5xl mx-auto px-6 py-16">
            <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-widest mb-8">What&apos;s included</h2>
        ...
        <section className="max-w-5xl mx-auto px-6 py-20">
          <div className="max-w-md">
            ...
            <p className="mt-2 text-sm text-gray-500">Spots are limited. Leave your email and we&apos;ll reach out when availability opens.</p>
            ...
            {status === 'success' ? (
              <div className="mt-8 p-5 bg-gray-50 border border-gray-200 rounded-lg">
                ...
                <p className="mt-1 text-sm text-gray-500">Thanks for signing up. We&apos;ll be in touch when a spot opens up.</p>
              </div>
            ) : (
